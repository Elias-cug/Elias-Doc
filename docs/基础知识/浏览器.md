...
2. screenLeft screenTop screenX screenY moveBy(x, y) moveTo(x, y)
3. innerWidth innerHeight outerWidth outerHeight resizeTo(width, height) resizeBy(width, height)
